...
(function ($) {
    ...
    $.alerts = {
        ...
        _show: function (title, msg, value, type, callback) {
            ...
            $("#popup_title").html("<div style=\"float:left;overflow:hidden;	font-size:16px;font-weight:bold;margin-top:5px;\">" + title + "</div><img id=\"imageClose\" src=\"/resources/images/JAlert/btn-close.png\" style=\" border:0;float:right;cursor:pointer;margin:5px\"/>");
            $("#imageClose").click(function () {
                $.alerts._hide();
                if (callback) callback(false);
            });
            $("#imageClose").focus().keypress(function (e) {
                if (e.keyCode == 13 || e.keyCode == 27) $("#imageClose").trigger('click');
            });
            $.alerts._reposition();
