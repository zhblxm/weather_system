...
public class VAgg extends vBaseEntity {
	private String startDate;
	private String endDate;
	private List<Integer> weatherStations;
	private List<String> parameters;
	private int totalRecords;
	public VAgg(vBaseEntity entity) {
		super(entity);
	}

	public VAgg(Timestamp createDate, String name, int id, String orderField, String orderType, int startIndex, int size) {
